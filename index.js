...
const MAS = process.env.MONGO_ATLAS_SRV;
...
const FACEBOOK_APP_ID = process.argv[3] || FID;
const FACEBOOK_APP_SECRET = process.argv[4] || FSECRET;
const modoCluster = process.argv[5] == 'CLUSTER';
const MONGO_ATLAS_SRV = process.argv[6] || MAS;
...
if(modoCluster && cluster.isMaster) {
    ...
    console.log(`Master ${process.pid} esta correindo`);
    ...
    app.listen(portCL, ()=>{
        console.log(`Servidor UP correindo en puerto - ${portCL}`);
        mongoose.connect(process.argv[6] || MAS, 
            {
    ...
    console.log(`Worker iniciado en ${process.pid}`);
};
